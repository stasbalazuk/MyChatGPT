...
type
  ...
  public
    property AllowCreateEngine: Boolean read FAllow_create_engine
      write FAllow_create_engine;
    property AllowFineTuning: Boolean read FAllow_fine_tuning
      write FAllow_fine_tuning;
    ...
    property AllowSearchIndices: Boolean read FAllow_search_indices
      write FAllow_search_indices;
  ...
  public
    ...
    property Permission: TArray<TModelPermission> read FPermission
      write FPermission;

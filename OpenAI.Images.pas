...
type
  ...
  TImageCreateParams = class(TJSONParam)
    ...
    /// The size of the generated images. Must be one of 256x256, 512x512, or 1024x1024.
    /// </summary>
    function Size(const Value: TImageSize = TImageSize.x256)
    ...
    /// The format in which the generated images are returned. Must be one of url or b64_json
    /// </summary>
    function ResponseFormat(const Value
      : TImageResponseFormat = TImageResponseFormat.Url)
      : TImageCreateParams; overload;
    /// <summary>
  ...
  TImageEditParams = class(TMultipartFormData)
    ...
    /// If mask is not provided, image must have transparency, which will be used as the mask.
    /// </summary>
    function Image(const Stream: TStream; const FileName: string)
      : TImageEditParams; overload;
    /// <summary>
    ...
    /// Must be a valid PNG file, less than 4MB, and have the same dimensions as image.
    /// </summary>
    function Mask(const Stream: TStream; const FileName: string)
      : TImageEditParams; overload;
    /// <summary>
    /// A text description of the desired image(s). The maximum length is 1000 characters.
    /// </summary>
    ...
    /// The size of the generated images. Must be one of 256x256, 512x512, or 1024x1024.
    /// </summary>
    function Size(const Value: string = '1024x1024'): TImageEditParams;
      overload;
    /// <summary>
    /// The format in which the generated images are returned. Must be one of url or b64_json.
    /// </summary>
  ...
  TImageVariationParams = class(TMultipartFormData)
    ...
    /// </summary>
    function Image(const Stream: TStream; const FileName: string)
      : TImageVariationParams; overload;
    /// <summary>
    /// The number of images to generate. Must be between 1 and 10.
    /// </summary>
    ...
    /// The size of the generated images. Must be one of 256x256, 512x512, or 1024x1024.
    /// </summary>
    function Size(const Value: string = '1024x1024')
      : TImageVariationParams; overload;
    /// <summary>
    /// The format in which the generated images are returned. Must be one of url or b64_json.
    /// </summary>
  ...
  public
    ...
    /// </summary>
    function Variation(ParamProc: TProc<TImageVariationParams>)
      : TImageGenerations;
  end;
...
function TImagesRoute.Create(ParamProc: TProc<TImageCreateParams>)
  : TImageGenerations;
begin
  Result := API.Post<TImageGenerations, TImageCreateParams>
    ('images/generations', ParamProc);
end;

function TImagesRoute.Edit(ParamProc: TProc<TImageEditParams>)
  : TImageGenerations;
begin
  Result := API.PostForm<TImageGenerations, TImageEditParams>('images/edits',
    ParamProc);
end;

function TImagesRoute.Variation(ParamProc: TProc<TImageVariationParams>)
  : TImageGenerations;
begin
  Result := API.PostForm<TImageGenerations, TImageVariationParams>
    ('images/variations', ParamProc);
end;
...
function TImageCreateParams.ResponseFormat(const Value: TImageResponseFormat)
  : TImageCreateParams;
begin
...
function TImageCreateParams.ResponseFormat(const Value: string)
  : TImageCreateParams;
begin
...
function TImageEditParams.Image(const Stream: TStream; const FileName: string)
  : TImageEditParams;
begin
...
function TImageEditParams.Mask(const Stream: TStream; const FileName: string)
  : TImageEditParams;
begin
...
function TImageVariationParams.Image(const FileName: string)
  : TImageVariationParams;
begin
  AddFile('image', FileName);
  Result := Self;
...
function TImageVariationParams.Image(const Stream: TStream;
  const FileName: string): TImageVariationParams;
begin
  AddStream('image', Stream, FileName);
  Result := Self;
end;
...
function TImageVariationParams.ResponseFormat(const Value: string)
  : TImageVariationParams;
begin
  AddField('response_format', Value);
  Result := Self;

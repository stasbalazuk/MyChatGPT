...
type
  TModerationsParams = class(TJSONParam)
    ...
    /// </summary>
    function Model(const Value: string = 'text-moderation-latest')
      : TModerationsParams;
    /// <summary>
  ...
  public
    ...
    property HateOrThreatening: Extended read FHatethreatening
      write FHatethreatening;
    ...
    property ViolenceOrGraphic: Extended read FViolencegraphic
      write FViolencegraphic;
  end;
  ...
  public
    ...
    property HateOrThreatening: Boolean read FHatethreatening
      write FHatethreatening;
    ...
    property ViolenceOrGraphic: Boolean read FViolencegraphic
      write FViolencegraphic;
  end;
  ...
  public
    ...
    property CategoryScores: TCategoryScores read FCategory_scores
      write FCategory_scores;
...
function TModerationsRoute.Create(ParamProc: TProc<TModerationsParams>)
  : TModerations;
begin
  Result := API.Post<TModerations, TModerationsParams>('moderations',
    ParamProc);
end;
...
function TModerationsParams.Input(const Value: TArray<string>)
  : TModerationsParams;
begin

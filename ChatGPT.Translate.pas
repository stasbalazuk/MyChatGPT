...
begin
  ...
  try
    var
    URI := TURI.Create('https://translate.googleapis.com/translate_a/single');
    ...
    URI.AddParameter('q', Text.Replace('...', '', [rfReplaceAll])
    ...
    try
      ...
      begin
        ...
        JSON := TJSONObject.ParseJSONValue
          (UTF8ToString(RawByteString(Response.DataString)));

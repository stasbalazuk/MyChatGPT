...
type
  TFineTuneCreateParams = class(TJSONParam)
    ...
    /// </summary>
    function LearningRateMultiplier(const Value: Extended)
    ...
    /// </summary>
    function PromptLossWeight(const Value: Extended = 0.01)
      : TFineTuneCreateParams;
    /// <summary>
    ...
    /// </summary>
    function ComputeClassificationMetrics(const Value: Boolean = True)
      : TFineTuneCreateParams;
    /// <summary>
    /// The number of classes in a classification task.
    /// This parameter is required for multiclass classification.
    /// </summary>
    function ClassificationNClasses(const Value: Integer)
      : TFineTuneCreateParams;
    /// <summary>
    /// The positive class in binary classification.
    /// This parameter is needed to generate precision, recall, and F1 metrics when doing binary classification.
    /// </summary>
    function ClassificationPositiveClass(const Value: string)
      : TFineTuneCreateParams;
    /// <summary>
    ...
    /// </summary>
    function ClassificationBetas(const Value: TArray<Extended>)
      : TFineTuneCreateParams;
    /// <summary>
  ...
  public
    ...
    property LearningRateMultiplier: Extended read FLearning_rate_multiplier
      write FLearning_rate_multiplier;
    property nEpochs: Extended read FN_epochs write FN_epochs;
    property PromptLossWeight: Extended read FPrompt_loss_weight
      write FPrompt_loss_weight;
  end;
  ...
  public
    ...
    property FineTunedModel: string read FFine_tuned_model
      write FFine_tuned_model;
    property Id: string read FId write FId;
    property Model: string read FModel write FModel;
    property &Object: string read FObject write FObject;
    property OrganizationId: string read FOrganization_id
      write FOrganization_id;
    property ResultFiles: TArray<TFile> read FResult_files write FResult_files;
    /// <summary>
    /// succeeded, cancelled, pending
    /// </summary>
    property Status: string read FStatus write FStatus;
    property TrainingFiles: TArray<TFile> read FTraining_files
      write FTraining_files;
    property UpdatedAt: Int64 read FUpdated_at write FUpdated_at;
    property ValidationFiles: TArray<TFile> read FValidation_files
      write FValidation_files;
    destructor Destroy; override;
  end;
  ...
  public
    ...
    /// </param>
    function ListEvents(const FineTuneId: string; Stream: Boolean = False)
      : TFineTuneEvents;
    /// <summary>
...
function TFineTunesRoute.Create(ParamProc: TProc<TFineTuneCreateParams>)
  : TFineTune;
begin
...
function TFineTunesRoute.ListEvents(const FineTuneId: string; Stream: Boolean)
  : TFineTuneEvents;
begin
  Result := API.Get<TFineTuneEvents>('fine-tunes/' + FineTuneId + '/events' +
    IfThen(Stream, '?stream=true'));
end;
...
function TFineTuneCreateParams.BatchSize(const Value: Integer)
  : TFineTuneCreateParams;
begin
  Result := TFineTuneCreateParams(Add('batch_size', Value));
end;

function TFineTuneCreateParams.ClassificationBetas
  (const Value: TArray<Extended>): TFineTuneCreateParams;
begin
  Result := TFineTuneCreateParams(Add('classification_betas', Value));
end;

function TFineTuneCreateParams.ClassificationNClasses(const Value: Integer)
  : TFineTuneCreateParams;
begin
  Result := TFineTuneCreateParams(Add('classification_n_classes', Value));
end;

function TFineTuneCreateParams.ClassificationPositiveClass(const Value: string)
  : TFineTuneCreateParams;
begin
  Result := TFineTuneCreateParams(Add('classification_positive_class', Value));
end;

function TFineTuneCreateParams.ComputeClassificationMetrics
  (const Value: Boolean): TFineTuneCreateParams;
begin
  Result := TFineTuneCreateParams(Add('compute_classification_metrics', Value));
end;

function TFineTuneCreateParams.LearningRateMultiplier(const Value: Extended)
  : TFineTuneCreateParams;
begin
  Result := TFineTuneCreateParams(Add('learning_rate_multiplier', Value));
end;

function TFineTuneCreateParams.Model(const Value: string)
  : TFineTuneCreateParams;
begin
  Result := TFineTuneCreateParams(Add('model', Value));
end;

function TFineTuneCreateParams.nEpochs(const Value: Integer)
  : TFineTuneCreateParams;
begin
  Result := TFineTuneCreateParams(Add('n_epochs', Value));
end;

function TFineTuneCreateParams.PromptLossWeight(const Value: Extended)
  : TFineTuneCreateParams;
begin
  Result := TFineTuneCreateParams(Add('prompt_loss_weight', Value));
end;

function TFineTuneCreateParams.Suffix(const Value: string)
  : TFineTuneCreateParams;
begin
  Result := TFineTuneCreateParams(Add('suffix', Value));
end;

function TFineTuneCreateParams.TrainingFile(const Value: string)
  : TFineTuneCreateParams;
begin
  Result := TFineTuneCreateParams(Add('training_file', Value));
end;

function TFineTuneCreateParams.ValidationFile(const Value: string)
  : TFineTuneCreateParams;
begin

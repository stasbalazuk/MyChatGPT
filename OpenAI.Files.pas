...
type
  ...
  TFileCreateParams = class(TMultipartFormData)
    ...
    /// fields representing your training examples.
    /// </summary>
    function &File(const Stream: TStream; const FileName: string)
      : TFileCreateParams; overload;
    /// <summary>
    ...
    /// Variants: ['fine-tune', 'answers', 'search', 'classifications']
    /// </summary>
    function Purpose(const Value: TFileCreatePurpose)
      : TFileCreateParams; overload;
  end;
...
function TFileCreateParams.&File(const Stream: TStream; const FileName: string)
  : TFileCreateParams;
begin
...
function TFileCreateParams.Purpose(const Value: TFileCreatePurpose)
  : TFileCreateParams;
begin

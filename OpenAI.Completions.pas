...
type
  ...
  private
    ...
    FTotal_tokens: Int64;
  public
    property CompletionTokens: Int64 read FCompletion_tokens
      write FCompletion_tokens;
...
function TCompletionsRoute.Create(ParamProc: TProc<TCompletionParams>)
  : TCompletions;
begin
...
function TCompletionParams.FrequencyPenalty(const Value: Single)
  : TCompletionParams;
begin
...
function TCompletionParams.PresencePenalty(const Value: Single)
  : TCompletionParams;
begin
...
function TCompletionParams.Prompt(const Value: TArray<string>)
  : TCompletionParams;
begin
  Result := TCompletionParams(Add('prompt', Value));
end;
